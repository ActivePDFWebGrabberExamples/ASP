...
' Specify specific HTML tags to use for conversion to bookmarks
' The order of the tags determines the bookmark hierarchy
oWG.BookmarkElementSelectors = "h1, h3, h5"

' Convert the specified tags into bookmarks
...
oWG.NewDocumentName = "bookmarks.pdf"
