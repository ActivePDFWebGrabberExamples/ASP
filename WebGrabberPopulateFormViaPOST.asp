...
oWG.AddHTTPPostData "input_name_first=John&input_name_last=Johnson&input_email=john.johnson@fakedomain.com&radio_gender=male&cb_vb=on&cb_vbs=on"
...
oWG.NewDocumentName = "authentication.pdf"
...
' Clear the post data if a subsequent conversion won't use it
oWG.ClearHTTPPostData 
