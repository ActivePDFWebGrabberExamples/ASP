...
' Set 128-bit encryption on PDF output
' 128-bit encryption supported in Acrobat 5+
' A blank user password will allow the PDF to open without a password
oWG.SetPDFSecurity128 "userpass", "ownerpass", true, true, true, true, true, true, true, true
...
oWG.NewDocumentName = "secure128bit.pdf"
